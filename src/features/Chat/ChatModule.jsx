...
const ChatModule = ({ selectedChat, handleClose }) => {
  ...
  const GetMessage = async () => {
    try {
      const response = await axios.get(
        `${
          process.env.REACT_APP_API_URL_MICROSERVICE4
        }/chat/${"ce836b22-96a6-462a-9cb7-1b8d90243a17"}`,
  ...
  //   sendMessage.sendMessage("ce836b22-96a6-462a-9cb7-1b8d90243a17", Message);
  //   setMessage("");
  // };
  const handleSend = () => {
    if (!Message.trim() || !role || !selectedChat) return;
