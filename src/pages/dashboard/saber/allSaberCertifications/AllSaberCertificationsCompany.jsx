...
import { GetAllSaberCertifications } from "../../../../store/Slice/allSaberCertifications";
import ChannelConnectionCompany from "../../../../features/Chat/ChannelConnectionCompany";
...
const AllSaberCertificatesCompany = () => {
  ...
  const GetAllSaber = async () => {
    setLoading(true);
    const { payload } = await dispatch(GetAllSaberCertifications(currentPage));
...
export default AllSaberCertificatesCompany;
